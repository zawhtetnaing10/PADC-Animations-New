...
//            }
            ...
            val translateYAnimator = ObjectAnimator.ofFloat(binding.btnText, "translationY", 0.0f, 500f).apply {
                duration = 2000
            }
...
//            // Animator Set
            AnimatorSet().apply {
                play(translateAnimator).with(translateYAnimator).before(fadeAnimator)
                start()
            }
        }
    }
